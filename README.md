...
| 功能                              | 说明                                                                                                                                                           | 相对原版的优势                                                       |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| 🔑 **API Key 配置引导**           | 首次使用弹出引导弹窗，快速配置 API Key                                                                                                                         | 原版需手动进入高级设置，上手门槛高                                   |
| 🎛️ **模型选择面板**               | 右下角悬浮面板，可切换 Agent 文本模型（`gpt-5.6-sol` 旗舰 / `gpt-5.6-terra` 均衡 / `gpt-5.6-luna` 轻量），悬停可查看各模型能力说明；图像模型固定 `gpt-image-2` | 原版文本模型固定写死，无法更换                                       |
