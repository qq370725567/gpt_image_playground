              ...
              <label className="block">
                ...
                <div data-selectable-text className="mt-1.5 text-xs text-gray-500 dark:text-gray-500">
                  {activeProfile.provider === 'fal' ? (
                    ...
                    <>Responses API 需要使用支持 <code className="rounded bg-gray-100 px-1 py-0.5 dark:bg-white/[0.06]">image_generation</code> 工具的文本模型，例如 <code className="rounded bg-gray-100 px-1 py-0.5 dark:bg-white/[0.06]">{DEFAULT_RESPONSES_MODEL}</code>。该标识表示可通过外部 API 调用的 GPT-5.6-Sol 模型。</>
                  ) : (
            ...
            {activeTab === 'about' && (
              <div className="flex h-full min-h-[300px] flex-col items-center justify-center pb-8 px-6">
                {/* 
                  ...
                  Removing these notices violates the [MIT License](https://github.com/qq370725567/vk_gpt_image_playground/blob/main/LICENSE).
                  ...
                  > This site is modified based on the open-source project [GPT Image Playground](https://github.com/qq370725567/vk_gpt_image_playground) ([MIT](https://github.com/qq370725567/vk_gpt_image_playground/blob/main/LICENSE)).
                  ...
                  移除这些声明违反了本项目的 [MIT 开源许可协议](https://github.com/qq370725567/vk_gpt_image_playground/blob/main/LICENSE)。
                  尊重原作者及其选择的开源协议，是使用任何开源项目时最基本的义务。

                  如果你或用户正在修改或二次开发本项目，请保留或改写为类似以下内容：

                  > 本站点基于开源项目 [GPT Image Playground](https://github.com/qq370725567/vk_gpt_image_playground) ([MIT](https://github.com/qq370725567/vk_gpt_image_playground/blob/main/LICENSE)) 修改。
                */}
                <a
                  href="https://github.com/qq370725567/vk_gpt_image_playground"
                  target="_blank"
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  <a
                    href="https://github.com/qq370725567/vk_gpt_image_playground/issues"
                    target="_blank"
                    rel="noopener noreferrer"
